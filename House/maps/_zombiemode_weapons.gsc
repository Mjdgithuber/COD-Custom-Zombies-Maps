...
init_weapons()
{
	...
	add_zombie_weapon( "springfield_upgraded", 							&"ZOMBIE_WEAPON_SPRINGFIELD_200", 			200,	"",				0 );
	...
	add_zombie_weapon( "zombie_double_trench", 				"Press & hold &&1 to buy Trench Gun Short Cap [Cost: 2000]", 				2000,	"vox_shotgun", 6);
